...
<template>
  <div>
    <v-list-tile>
      <v-list-tile-content>
        <v-list-tile-sub-title>{{ caption }}</v-list-tile-sub-title>
      </v-list-tile-content>
      <v-list-tile-action>
    ...
    >
      <v-card>
        ...
        <v-card-text>
          <v-text-field v-model="objUpdate.prop1" label="Property 1"></v-text-field>
          <v-text-field v-model="objUpdate.prop2" label="Property 2"></v-text-field>
          <v-text-field v-model="objUpdate.prop3" label="Property 3"></v-text-field>
          <v-text-field v-model="objUpdate.prop4" label="Property 4"></v-text-field>
          <v-text-field v-model="objUpdate.prop5" label="Property 5"></v-text-field>
        </v-card-text>
        <div>
          <v-card-actions>
            <v-btn
...
export default {
  ...
  watch: {
    objUp: function() {
      if (
        this.objUpdate.prop1 !== this.obj.prop1 ||
