      ...
      <v-card-text class="pa-4">
        <v-layout v-if="step === 1" row wrap justify-center>
          <v-flex>
            ...
            >
              <v-container class="image-drop-area grey lighten-4" fluid fill-height>
                <v-layout column justify-center align-center>
                  <v-alert
                    ...
                    icon="add_a_photo"
                  >Click or drag image file here</v-alert>
                  <v-alert
                    :value="showError"
                    outline
                    color="error"
                    icon="add_a_photo"
                  >{{ errorMessage }} Select another image.</v-alert>
          ...
          <v-flex xs12 sm4>
            <v-card class="pa-0 ma-0 elevation-0 transparent">
              <v-layout row wrap justify-center align-center>
                <v-avatar v-if="false" class="my-2 mx-4 elevation-2" tile :size="90">
                ...
                <v-avatar class="my-2 mx-4 elevation-2" :size="90">
                  <template v-if="sourceImgUrl.length > 0">
                    <img :src="sourceImgUrl">
                  </template>
                  <template v-else>
...
export default {
  ...
  methods: {
    ...
    onUpload() {
      ...
      var documentFile = new Blob([this.sourceImgUrl], {
        type: 'text/plain'
      })
